"""eskge"""
# 1. รับค่าและแปลงเป็นตัวเลขทศนิยม (เช่น 9.00 -> 9.0)
time_in = float(input())
time_out = float(input())

# 2. คำนวณหาจำนวนชั่วโมง และ เศษนาที (แปลงค่าทศนิยมเป็นนาที)
...
# 3. รวมเวลาทั้งหมดเป็นหน่วย "นาที" เพื่อหาผลต่าง
total_in = (h_in * 60) + m_in
total_out = (h_out * 60) + m_out
diff = total_out - total_in

# 4. เช็คเงื่อนไขตามที่โจทย์สั่ง
