...
```text
โจทย์ให้ทำการแปลงค่าอุณหภูมิ โดยใช้สูตรการเปลี่ยนหน่วยอุณหภูมิเป็นหน่วย ฟาเรนไฮต์,เคลวิน, และแรงคิน จากหน่วยเซลเซียส
```
...
```text
ตั้งตัวแปรแต่ละตัวว่ามีค่ายังไง คิดยังไง ใช้สูตรไหน
```
...
```text
ตั้งฟังก์ชัน ว่า ถ้าตัวแรกเป็นอุณหภูมินึงและอีกอันนึงเป็นอีกอุณหภูมินึง จะใช้สูตรอะไรและผลลัพย์เป็นเท่าไหร่ ลงคำสั่งอินพุดรับค่าอุณหภูมิที่จะคำนวน หน่วยตัวแรก และหน่วยตัวที่สอง จากนั้นเรียกใช้ฟังก์ชันออกมา
```
...
```text
เพราะอยากรู้ว่าเงื่อนไขของ ถ้า C ขึ้นก่อน จะเป็นยังไง
```
...
```text
ช่วยอธิบายโจทย์ และไกด์ให้ว่าต้องเริ่มยังไง ใช้ตัวแปรไหน
```

คุณยังทำอะไรด้วยตนเอง

```text
เขียนโค้ดต่อด้วยตนเอง
```
