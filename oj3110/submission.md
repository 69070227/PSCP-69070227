...
```text
คํานวณค่าธรรมเนียมการส่งพัสดุจะต้องเลือกต้นทาง - ปลายทาง น้ำหนักของพัสดุ
Input:
ต้นทาง ปลายทาง
น้ำหนักของพัสดุ
...
```text
Step 1: รับค่า
Step 2: ตรวจว่าต้นทาง ปลายทาง คืออะไร
Step 3: กําหนดตารางอัตราค่าธรรมเนียม ทั้งของภาษีเริ่มและ ภาษีน้ำหนัก
Step 4: คำนวนราคา โดย เอาน้ำหนักคูณกับภาษีน้ำหนัก + ภาษีเริ่มต้น
Step5: แสดงผลออกมาเป็นทศนิยมสองตำแหน่ง
```
...
```text
กําหนดตารางอัตราค่าธรรมเนียม แต่เพิ่มเติมการรับค่าคือ ให้แปลงเป็นตัวพิมพ์ใหญ่ทั้งหมด
```
