...
```text
เขียนหาจำนวนเฉพาะและแสดงค่าแค่จำนวนเฉพาะ และบอกจำนวนเฉพาะที่มี
```
...
```text
ก่อนทำคิดว่าให้เอาเลขไปหารจำนวนเฉพาะเรื่อยๆ ถ้าหารลงตัวแสดงว่าไม่ใช่จำนวนเฉพาะ
```
...
```text
รับค่าเริ่มและสิ้นสุด จากนั้นใช้ for loop รันค่าจากเริ่มถึงจำนวนเริ่มถึงสุดท้ายบวกหนึ่งเพราะจะเอาค่าตัวสุดท้ายด้วย โดยใช้for loop อีกอัน ใช้ i นับเป็นตัวหาร เงื่อนไขคือถ้าจำนวน n หาร i ลงตัว ให้หยุดตรวจค่า n ตัวนั้น เพราะมันมีตัวอื่นหารลงตัวได้อีกนอกจากตัวเอง
อีกเงื่อนไขคือ ถ้าอันก่อนหน้าทำเงื่อนไขเสร็จแล้ว และ n มากกว่าหนึ่ง แสดงว่าเลขนั้นเป็นจำนวนเฉพาะ ให้เพิ่มเข้าลิสต์
```
