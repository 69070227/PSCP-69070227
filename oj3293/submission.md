...
```text
รับค่าสตริงแล้วเอาทั้งหมดใส่กรอบ แต่ความกว้างของกรอบจะขยายตาม string ที่ยาวที่สุด
```
...
```text
ขั้นตอนแรก รับค่าสตริงมาในแต่ละบรรทัดตัดช่องว่างออกด้วย strip แล้วนำไปใส่ในกล่องลิสต์ 
สอง ใช้ for loop หาความยาวข้อความที่ยาวที่สุดที่มี
จากนั้นprint กรอบบนที่คูนกับความยาวของข้อความที่ยาวที่สุดที่บวกสี่
ช่วงกลาง print ข้อความโดยข้อความทั้งหมดจะทำการชิดซ้ายในช่องความกว้างของความยาวของข้อความที่ยาวที่สุด (i:<{max_text})
```
...
```text
ทดสอบตัวที่มีความกว้างเหมือนกัน
```
