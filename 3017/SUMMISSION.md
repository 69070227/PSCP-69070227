...
```
    ...
    โจทย์ให้แสดงข้อความเดิมให้กลับด้าน และให้ทำให้ตัวเล็กทั้งหมดด้วย
    Input: รับข้อความ (string) 1 บรรทัด
    Output: แสดงข้อความเดิมในลำดับตัวอักษรที่กลับด้าน
    Constraints: 5
```
...
```
    ทีแรกเข้าใจว่าให้ใช้ for loop ทำงานเรียงซ้ำจากหน้าไปหลังแบบ สลับตัวแรกสุดกับหลังสุดและลงมาเรื่อยๆ 
Step 1: ตั้งตัวแปรเก็บค่าที่ผู้ใช้อินพุด
Step 2:ตั้งเงื่อนไขให้สลับตัวแรกสุดกับหลังสุดและลงมาเรื่อยๆ 
Step 3:ลองoutput
```
...
```แต่พอหาวิธีจริงๆสามารถสั่งให้พิมพ์ย้อนกลับได้โดยนับพิมพ์ถอยหลังจากหลังสุดด้วยลบหนึ่งลงมาเรื่อยๆ โดยใช้ [::-1]
...
```เพราะลืมเช็คว่า output ต้องตัวเล็กทั้งหมดด้วย เลยแก้โค้ดให้ เติม casefold เพิ่มเข้าไป และทดสอบอีกครั้ง
...
harry
```
ลองเอา sample testcases ของเขามาเช็คครั้งสุดท้ายว่าตรงกับเขาไหม ถูกรึป่าว
