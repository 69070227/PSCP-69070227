...
```text
โจทย์ให้หาว่าถ้าคะแนนโหวดของคนที่ให้คะแนนสูงสุดและต่ำสุดห่างกันเกินสองคะแนนจะSurprising ถ้าไม่จะเป็นNot surprising
Input:
บรรทัดที่ 1: คะแนนรวมของทั้งสามคน
บรรทัดที่ 2: คะแนนสูงสุดของทั้งสามคน
...
```text
Step 1: รับค่าของทั้งสาม และคะแนนสูงสุด
Step 2: นำคะแนนรวมทั้งสามมาลบกับมากสุดเพื่อหาจำนวนค่าที่เหลือ
Step 3: หาค่าน้อยสุดโดยนำค่าเหลือมาลบกับค่ามาก (ถ้าติดลบให้แปลงค่าเป็น 0)
Step 4: หาว่าค่ามากสุดกับค่าน้อยสุดต่างกันกี่คะแนน
Step 5:  ถ้าห่างกันสองคะแนน ให้แสดงผล "Surprising"
Step 6: ถ้าไม่ให้แสดงผล "Not surprising"
```
...
```text
เหมือนแผนแรก เพิ่มเติมแค่เปลี่ยนวิธีรับค่าจาก int เป็น float
```
...
```text
ทดสอบว่าได้ผลเหมือนตัวอย่างไหม
```
...
```text
อธิบายแนวคิด การใช้สูตร
```

คุณยังทำอะไรด้วยตนเอง

```text
ปรับแปลงสูตร เขียนเอง ทดสอบ
```
