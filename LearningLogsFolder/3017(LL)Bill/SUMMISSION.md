...
```
    ...
    โจทย์ให้คำนวนค่าบริการ ถ้าราคาห้าร้องพอหาได้ค่าบริการจะคิดเป็นห้าสิบบาท ถ้ามากกว่านั้นค่าบริการจะคิดไม่เกินพัน
```
...
Step 2:กำหนดเงื่อนไขว่าถ้าราคาน้อยกว่าห้าร้อยจะคิดค่าบริการเป็นห้าสิบบาท มากกว่านั้นคือค่าบริการไม่เกินพัน
Step 3:ลองoutput
```
...
```เพราะใส่เงื่อนไขผิด ยังอ่านโจทย์ไม่แตก เลยปรึกษาให้เพื่อนช่วยและลองทดสอบใหม่
...
```
ลองคิดว่ามี testcases อื่นๆที่เป็นไปได้ไหม แต่เอากลับไปแก้ในโค้ด
...
```เพื่อน lab pscp ที่ได้คู่กัน

```

เขาช่วยอะไร

```ช่วยอธิบายคอนเซป สูตรการคิดของโจทย์ข้อนี้ว่าต้องคำนวนยังไง
