...
```text
ตรวจเลขสลากข้องกระต่ายน้อยกับผลสลากกินแบ่ และแสดงเงินรางวัลที่กระต่ายน้อยได้รับ
```
...
```text
รับค่าและแบ่งตัวอักษรกับตัวเลข  ต่อด้วย for loop จากนั้นใช้ slicing method เทียบเลขระหว่างกสลากระต่ายกับเลขสลาก 
```
...
```text
หลังจากลองอ่านโค้ดเก่าที่ผ่าน เราสังเกตว่าไม่จำเป็นต้องใช้ for loop มันแค่เทียบตำแหน่งทีละตัวโดยใช้ slicing method และตรรกะ and/or/not
```
