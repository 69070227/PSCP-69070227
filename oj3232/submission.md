...
```text
โจทย์ให้นับจำนวนครั้งที่กระโดด โดยโจทย์จะกำหนดว่ากบต้องกระโดดถึงเท่าไหร่ และกบกระโดดได้เท่าไหร่ โดยแต่ละครั้งที่กบกระโดดจำนวนที่กบจะกระโดดได้จะลบสองไปเรื่อยๆ 
```
...
```text
รับค่าโดยใช้ spilt เพื่อแบ่งว่าอันไหนของกบกระโดดได้ กับ จุดเป้าหมาย
ใช้ whille loop และเขียนคำสั้งบอกว่า ในขณะที่เอาความต่าระหว่างกบกระโดดได้กับเป้าาหมายมาลบกัน ยังมากกว่า 0  ให้นับจำนวนครั้งที่กระโดดได้หนึ่งครั้ง จากนั้นค่อยลบจำนวนที่กบกระโดดได้ออก วนไปเรื่อยๆ ถ้าจบแล้วเท่ากับ 0 ให้แสดงผลจำนวนครั้งที่กบกระโดด ถ้าจำนวนที่กบกระโดดได้เหลือ0 แต่ระยะทางยังมากกว่า 0 ให้แสดงค่า -1  
```
...
```text
เหมือนแผนแรก แต่เพิ่มตัวแปรอีกอันคือ current คือตัวแปรที่บอกให้รู้ว่าตอนนี้อยู่ตำแหน่งที่เท่าไหร่
เงื่อนไขแรกถ้าจุดเป้าหมายยังมากกว่ากบกระโดดได้ ให้เข้า while loop ตั้งให้เป็นในขณะที่ current น้อยกว่าจุดเป้าหมาย และ กบกระโดดได้มากกว่า0 ให้current บวกค่าที่กบกระโดดได้ไปก่อน และ นับจำนวนครั้ง จากนั้นลบสองกบกระโดดได้ วนไปเรื่อยๆจน ถ้า current เท่ากับหรือมากกว่าเป้าหมายแสดงว่าเราถืงเป้าหมายแล้วให้ปริ้นจำนวนครั้งออกมา แต่ถ้าไม่ถึงเป้าหมายหรืออืื่นๆให้-1
เพิ่มว่าถ้ากบกระดดดได้มีค่าเท่ากับเป้าหมาย ก็แสดงผลเป็น 1 ได้เลย
```
