...
```text
ให้หายอดสุืธิของสินค้าที่นักเรียนซื้อ ถ้าเป็นสมาชิกจะสด 5% ถ้าไม่แต่ยอดรวมถึงหรือมากกว่า500บาทจะลด 3%
```
...
```text
Step 1: รับค่า ว่าเป็นสมาชิกหรือไม่
Step 2: รับค่าจำนวนสินค้า
Step 3: for loop จำนวนสินค่าเอาไปใส่ในลิส แล้วเอาทั้งหมดมารวมบวกกัน
Step 4: คิดของ "ถ้าเป็นสมาชิก" ให้คูณ0.05
 Step 5: คิดของ "ถ้าไม่เป็นสมาชิก แต่ ยอดสินค้ารวมมีมากกว่า500บาท" ให้คูณ0.03
 Step 6: คิดของ "ถ้าไม่เป็นสมาชิก" ให้คิดออกมาเลย
```
...
```text
ใช้เหมือนแผนแรก แต่ ใช้หลักการ math.ceil เพื่อปัดขึ้นเป็นจำนวนเต็ม
