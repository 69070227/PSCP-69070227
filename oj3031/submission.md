...
```text
https://ijudge.it.kmitl.ac.th/submissions/578323/overview
```
...
```text
รับข้อมูลเวลาการขยายพื้นที่ของน้ำหมึก  และ คนที่ร้อง
เรากำลังหาว่า แต่ละคนบ้านเขาที่อยู่ตำแหน่งนั้นจะจมที่เวลาเท่าไหร่
```
...
```text
Step 1:ะบุจำนวนเต็ม S (1 <= S <= 100000) แทนพื้นที่ที่น้ำหมึกแผ่ขยายไปต่อหนึ่งวินาที และจำนวนเต็ม N (1 <= N <= 100) แทนจำนวนคำร้องจากผู้คน
Step 2: ใช้ for loop วนคน ทำตามค่าคนไปเรื่อยๆ ของแต่ละคน
Step 3: รับอินพุดพิกัด x y แทนพิกัดของบ้านของคนที่ i
Step 4: คำนวนพื้นที่วงกลมของพิกัดนั้น
Step 5:คำนวนเวลาที่น้ำหมึกจะไปถึงบ้านนั้น solutime v = s/t
Step 6: วนครบ แสดงผลเวลาของแต่ละบ้าน
```
...
```text
เหมือนแผนแรก แต่เพิ่มนิดหน่อยคือ การปัดเศษขึ้นของเวลา เพื่อนสอนการใช้ mathceil()
```
...
```text
ใบ้ว่าข้อนี้ใช้สูตรฟิสิกส์ แต่ใช้เป็นพื้นที่วงกลม และสอน mathceil()
```

คุณยังทำอะไรด้วยตนเอง

```text
นำคำใบ้นั้นมาลองเขียนเอง
```
