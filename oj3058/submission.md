...
```text
โจทญ์ให้คำนวนว่าจะอิฐที่มีพอไหมที่จะสร้างสะพานได้
Input:
รับจำนวนอิฐ เล็ก ใหญ่ และความยาวสะพาน
Output:
อิฐที่เหลือจากการสร้าง หรือ สร้างไม่ได้
...
```text
รับค่า 
คำนวนว่า เราจะใช้อิฐใหญ่ได้มากที่สุดกี่ก้อน โดยต้องไม่เกินทั้งจำนวนอิฐที่เรามี และจำนวนที่เป้าหมายอนุญาตให้ใช้
จากนั้นหาอิฐที่เหลือ
ถ้าเหลือมีน้อยกว่าอิฐเล็ก ให้ปริ้นเหลือออกมา ถ้าไม่ให้แสดง -1
```
...
```text
ใช้เหมือนแผนแรก แค่เปลี่ยนวิธีคำนวน
```
