...
เขียนโปรแกรมแสดงฤดูกาล สำหรับวันและเดือนที่กำหนดมา inputมีสองตัวคือ ค่าตัวเลขของวันและอันที่สองคือเดือน ฤดูกาลจะเปลี่ยนแปลงตั้งแต่วันที่21ของเดือนที่หารสามลงตัว โดยจะเปลี่ยนจากฤดูปัจจุบันเป็นเดือนถัดไป
...
กำหนดตัวแปรรับค่าวันและเดือนจากนั้น ใช้เงื่อนไขตั้งว่าเดือน1,2,3จะเป็นฤดูหนาว และต่อไปเรื่อยๆ จากนั้นตั้งเงื่อนไขของการจะเปลี่ยนฤดูตรงวันนี้21เป็นต้นไปของเดือนที่หารสามลงตัว
...
จากการทดสอบอันที่แล้วที่ไม่ผ่าน จึงเลือกปรึกษาเพื่อนใหม่ว่ายังขาดจุดไหนไป และลองอันอื่นนอกจาก samples
...
พยายามเข้าใจโจทย์และเขียนด้วยตัวเอง
