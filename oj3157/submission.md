...
```text
เริ่มต้นด้วยคะแนน 0 คะแนน อินพุตรับจํานวนเต็ม N แทนจํานวนครั้งของการกระทํา
และตามด้วยคําสั่ง N ครั้ง แต่ละคําสั่งมีได้ 2 แบบคือ

ถ้าเป็นเครื่องหมาย "+" เพิ่ม  10 คะแนน
ถ้าเป็นเครื่องหมาย "-"ลด 5 คะแนน
```
...
```text
รับค่าจำนวนรอบ (N)
ใช้ for loop ในการวน (N) 
ในลูบจพทำการรับค่าของเครื่องหมาย + , - และใส่เงื่อนไข ถ้าเป็นเครื่องหมาย "+" เพิ่ม  10 คะแนน
ถ้าเป็นเครื่องหมาย "-"ลด 5 คะแนน
เอาท์พุตค่าออกมา
```
...
```text
ใช้เหมือนแผนแรก แต่เพิ่มแค่ ตัวแปรเริ่มของ result ให้มีค่าเท่ากับศูนย์
```
