...
```text
inputชื่อย่อของไพ่แต่ละใบ และแปลงเป็นชื่อเต็มตามสัญลักษณ์ของไพ่ที่ได้รับ
```
...
```text
Step 1:รับค่าแล้วนำไปใส่ลิสต์
Step 2: แบ่งเป็นสองลิสคือ ลิสต์ตัวหน้า และตัวหลัง
Step 3: แล้วตรวจของค่าข้างหน้าว่า ค่าที่ใส่ไปของตัวหน้าตรงกับเลขหรือตัวอักษร
Step 4: ตรวจของตัวหลังว่าตรงกับอะไร
Step 5:เอาทั้งหมดมาเอาท์พุต
...
```text
Step 1:รับค่าแล้วตรวจว่า ค่าที่ใส่ไปนั้นมีกี่ตัว สองหรือสาม
Step 2: ถ้ามี2ตัว ให้นับแค่ตัวตำแหน่ง[0] เป็นหนึ่งตัวแรก
Step 3: ถ้ามี3ตัว ให้นับตัวตำแหน่ง[0] และ [1] เป็นสองตัวแรก
Step 4:จากนั้นให้สร้างตัวแปรตัวสุดท้ายโดยใช้ตำแหน่ง[-1] เพราะนับตัวสุดท้ายมันเริ่มที่ -1 ในไพธ่อน
Step 5:ตั้งเงื่อนไขว่าตัวข้างหน้าเป็นตัวอักษรไหน แล้วค่อยดูว่าชื่อเต็มคือไร ถ้าไม่ใช่ตัวอักษรก็เอาท์พุดเป็นตัวเลขเลย
Step 6:ตั้งเงื่อนไขว่าตัวข้างหลังเป็นตัวอักษรไหนแล้วค่อยดูว่าชื่อเต็มคือไร

step 7 output เป็น print(f"{FORNT} of {LAST}")
```
...
```text
ช่วยสอนการดูว่า คำที่รับมามีสองหรือสามตัว
```
