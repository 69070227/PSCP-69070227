...
```text
https://ijudge.it.kmitl.ac.th/submissions/575594/overview
```
...
```text
เขียนโปรแกรม นับสระ ที่อยู่ในข้อความ โดย นับแค่ a e i o u
Input:
รับข้อความหนึ่ง

Output:
โปรแกรมควรพิมพ์แสดงสระที่นับได้ว่าได้กี่ตัว
```
...
```text
คิดว่าให้ใช้ defแบ่งว่า ฟังก็ชันนี้นับสระ ฟังก์ชันนึงให้เอาสระนั้นแปลงให้ไปนับสระ แล้วนำไปนับว่ากี่ตัว จากนั้นให้นับแบบตำแหน่งlist คือถ้าเจอ เอ ให้บวกเพิ่มในลิสต์ ที่ตำแหน่ง[0]
```
...
```text
สุดท้ายรู้ว่า ไม่จำเป็นต้องใช้ def 
รับค่าอินพุดเป็นข้อความหนึ่ง
ขั้นแรกคือกำหนดlist ที่เก็บค่า a e i o u ไว้
สอง list ที่เอาไว้เก็บค่าว่า ตำแหน่งที่ตรงกับ a e i o u มีเท่าไหร่
สาม ใช้ for loop นับค่าในประโยคข้อความที่อินพุดไป สมมติถ้าเจอ a ให้ countที่ตำแหน่งที่ 0 ไปหนึ่งตัว
สี่ ใช้ for loop ใส่เงื่อนไข ว่าถ้า count ในแต่ละตำแหน่งมีค่ามากกว่า 0 ให้ print ออกมาเป็นค่าของตำแหน่งในlist aeiou และ list ที่เก็บค่าสระว่ามีกี่ตัว
```
...
```text
อยากรู้ว่าจะเอาท์ออกมาครบห้าตัวไหม
```
